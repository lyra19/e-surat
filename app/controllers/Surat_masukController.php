...
class Surat_masukController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				surat_masuk.tgl_surat LIKE ? OR 
				surat_masuk.no_surat LIKE ? OR 
				surat_masuk.perihal LIKE ? OR 
				surat_masuk.asal_surat LIKE ? OR 
				surat_masuk.tgl_turun LIKE ? OR 
				surat_masuk.disposisi LIKE ? OR 
				surat_masuk.pengolah LIKE ? OR 
				surat_masuk.tgl_diterima LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("no_agenda","tgl_surat","no_surat","perihal","asal_surat","tgl_turun","disposisi","pengolah","tgl_diterima");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_surat","no_agenda","tgl_surat","no_surat","perihal","asal_surat","tgl_turun","disposisi","pengolah","tgl_diterima");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'no_agenda' => 'required',
