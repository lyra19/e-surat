                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-tgl_turun"> Tgl Turun</th>
                                                <th  class="td-disposisi"> Disposisi</th>
                                                <th  class="td-pengolah"> Pengolah</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id_surat"><a href="<?php print_link("surat_masuk/view/$data[id_surat]") ?>"><?php echo $data['id_surat']; ?></a></td>
