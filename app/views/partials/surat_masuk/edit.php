                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <label class="control-label" for="tgl_turun">Tgl Turun <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="input-group">
                                                                    <input id="ctrl-tgl_turun" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['tgl_turun']; ?>" type="datetime" name="tgl_turun" placeholder="Enter Tgl Turun" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                                        <div class="input-group-append">
                                                                            <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-disposisi"  value="<?php  echo $data['disposisi']; ?>" type="text" placeholder="Enter Disposisi"  required="" name="disposisi"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <label class="control-label" for="pengolah">Pengolah <span class="text-danger">*</span></label>
                                                                    </div>
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-pengolah" name="pengolah"  placeholder="Select a value ..."    class="custom-select" >
                                                                                <option value="">Select a value ...</option>
                                                                                <?php
                                                                                $pengolah_options = Menu :: $pengolah;
                                                                                $field_value = $data['pengolah'];
                                                                                if(!empty($pengolah_options)){
                                                                                foreach($pengolah_options as $option){
                                                                                $value = $option['value'];
                                                                                $label = $option['label'];
